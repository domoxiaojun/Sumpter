...
impl CompletionGuard {
    ...
    fn client_event(&self, status: i64, message: Option<String>) -> RuntimeEvent {
        ...
        RuntimeEvent {
            ...
            model_group_id: endpoint.and_then(|e| e.model_group_id.clone()),
            model_group_name: endpoint.and_then(|e| e.model_group_name.clone()),
            ...
            sticky_key: self.meta.sticky_key.clone(),
            status_code: status,
