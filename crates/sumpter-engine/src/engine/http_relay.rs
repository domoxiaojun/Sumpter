...
impl Engine {
    ...
    pub(super) fn relay(
        ...
        let body_stream = futures_util::stream::unfold(state, move |mut st| async move {
            if st.finished {
